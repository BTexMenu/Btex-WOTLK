--------------------------------------------------------------------------------------------------------
--                                               BTEX(Bottom TEXture)                                 --
--                                      V3.4 (WoW 3.4.3) - 2022 by Zetaprime82                        --
...
--------------------------------------------------------------------------------------------------------
-- Slash command
SLASHLOAD = " by Zetaprime82 is loaded. |c00bfffffUse '/btex menu' for configuration options.|r";
...
-- Slash command
SLASHLOAD = " par Zetaprime82 est charg\195\169. |c00bfffffUtilisez '/btex menu' pour les options de configuration.|r";
...
-- Slash command
SLASHLOAD = "Zetaprime82 активизировал addon.|c00bfffff использовать '/btex menu' для возможностей конфигурации|r";
...
-- Slash command
SLASHLOAD = " von Zetaprime82 ist geladen. |c00bfffffBenutze '/btex menu' fuer die Konfigurationsoptionen.|r";
...
-- Slash command
SLASHLOAD = " by Zetaprime82 已加载. |c00bfffff使用 '/btex menu' 进行设置.|r";
...
-- Slash command
SLASHLOAD = " by Zetaprime82 已加載. |c00bfffff使用 '/btex menu' 進行設置.|r";
